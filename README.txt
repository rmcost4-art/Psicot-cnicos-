# Treino Psicotécnicos VMER — PWA V6.1
...
V6.1: ícone alterado para amarelo de alta visibilidade com elementos azuis.
...
V6.1: ícone final aprovado, amarelo, com “Psicotécnicos” e Estrela da Vida azul.
...
V6.1 — Destreza bimanual dinâmica
...
V6.1 — Dificuldade adaptativa global
...
V6.1 — Condução psicomotora com giroscópio
...
V6.1 — Correção crítica: removido bloco JavaScript duplicado que impedia os botões da aplicação de responder.

V6.1 — Corrigida a navegação do menu, incluindo Destreza bimanual. O sistema de separadores foi refeito de forma mais robusta.
