# Treino Psicotécnicos VMER — PWA V6.0
...
V6.0: ícone alterado para amarelo de alta visibilidade com elementos azuis.
...
V6.0: ícone final aprovado, amarelo, com “Psicotécnicos” e Estrela da Vida azul.
...
V6.0 — Destreza bimanual dinâmica
...
V6.0 — Dificuldade adaptativa global
...
V6.0 — Condução psicomotora com giroscópio
...
V6.0 — Correção crítica: removido bloco JavaScript duplicado que impedia os botões da aplicação de responder.

V6.0 — Corrigida a navegação do menu, incluindo Destreza bimanual. O sistema de separadores foi refeito de forma mais robusta.
