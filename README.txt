# Treino Psicotécnicos VMER — PWA V6.2
...
V6.2: ícone alterado para amarelo de alta visibilidade com elementos azuis.
...
V6.2: ícone final aprovado, amarelo, com “Psicotécnicos” e Estrela da Vida azul.
...
V6.2 — Destreza bimanual dinâmica
...
V6.2 — Dificuldade adaptativa global
...
V6.2 — Condução psicomotora com giroscópio
...
V6.2 — Correção crítica: removido bloco JavaScript duplicado que impedia os botões da aplicação de responder.

V6.2 — Corrigida a navegação do menu, incluindo Destreza bimanual. O sistema de separadores foi refeito de forma mais robusta.
